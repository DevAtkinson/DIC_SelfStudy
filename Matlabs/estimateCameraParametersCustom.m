function [cameraParams, imagesUsed, estimationErrors] = estimateCameraParametersCustom(varargin)
...
%   leftImages = imageSet(fullfile(toolboxdir('vision'), 'visiondata', ...
%       'calibration', 'stereo', 'left'));
%   rightImages = imageSet(fullfile(toolboxdir('vision'), 'visiondata', ...
%       'calibration', 'stereo', 'right'));
%
%   % Detect the checkerboards.
%   [imagePoints, boardSize] = ...
%     detectCheckerboardPoints(leftImages.ImageLocation, rightImages.ImageLocation);
%
